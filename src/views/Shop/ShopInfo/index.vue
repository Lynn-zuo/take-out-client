  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" :class="suppportClasses[support.type]" v-for="(support, index) in shopInfo.supports" :key="index">
      ...
      <section class="section">
        ...
        <ul class="detail">
          ...
          <li>
            <span class="bold">营业时间</span><span>{{shopInfo.workTime}}</span>
          </li>
        </ul>
      </section>
    </div>
